...
class SpotIndex extends React.Component {
  ...
  filteredSpots = () => {
    ...
    return spots.filter((spot) => {
      return (
        result.test(spot.country) ||
        result.test(spot.continent) ||
        result.test(spot.spot) ||
        result.test(spot.difficulty) ||
        result.test(spot.season) ||
        result.test(spot.waveType)
      );
    });
  };
      ...
      <div className="spotsCollection">
        ...
        <div className="field box index-search">
          <div className="control index-search-bar">
            <input
              className="input is-primary is-rounded indexpage"
              name="search"
              type="text"
        ...
        <section
          className={`${
            this.state.hideGrid ? "section spot-grid is-hidden" : "spot-grid"
          }`}
        >
        ...
        <section
          className={`${
            this.state.hideMap ? "section spot-map is-hidden" : "spot-map"
          }`}
        >
