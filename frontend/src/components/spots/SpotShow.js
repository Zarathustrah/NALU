...
class SpotShow extends React.Component {
  ...
  handleCommentSubmit = async (e, rating, text) => {
    ...
    try {
      ...
      this.setState(
        { spot: res.data, errors: "", commentText: "", commentRating: "" },
        () => {
          this.handleRating();
        }
      );
    ...
    return (
      <div className="SpotShow box">
        <div className="hero is-medium is-success show">
          <div
            className="hero-body individual"
            style={{ backgroundImage: `url(${spot.image})` }}
          >
            <h1 className="surfspot">
              {spot.spot}, {spot.country}
            </h1>
          </div>
        </div>
        <div className="weather-info">
          <div className="columns is-multiline">
            ...
            <section className="column is-one-third marine-weather">
              ...
              <h1>
                Sea Level: {localMarineWeather.hours[0].seaLevel.meto} Tidal
              </h1>
              <h1>
                Swell Direction:{" "}
                {localMarineWeather.hours[0].swellDirection.meteo}
              </h1>
              <h1>
                Swell Height: {localMarineWeather.hours[0].swellHeight.meteo} SH
              </h1>
              <h1>
                Water Temp: {localMarineWeather.hours[0].waterTemperature.meto}
                °C
              </h1>
              <h1>
                Wave Height: {localMarineWeather.hours[0].waveHeight.meteo} WH
              </h1>
            </section>
            <hr />
            ...
            <div className="column">
              <div className="column is-half">
                <h1 className="title-show">
                  Location: {spot.region}, {spot.country}
                </h1>
                <br />
                <SpotMiniMap spot={this.state.spot} />
              </div>
            </div>
            <div className="column">
              <div className="column is-half">
